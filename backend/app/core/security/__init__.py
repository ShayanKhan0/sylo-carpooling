...
def verify_password(plain_password: str, hashed_password: str) -> bool:
    ...
    try:
        ...
        # Fallback for environments where passlib+bcrypt backend probes fail.
        try:
...
def get_password_hash(password: str) -> str:
    ...
    try:
        ...
        # Fallback keeps auth functional even if passlib backend probing fails.
...
# Re-export admin auth functionality
